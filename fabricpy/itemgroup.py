...
class ItemGroup:
    ...
    def __init__(self, item_id: str = None, name: str = None, icon: Optional[Type] = None, id: str = None):
        ...
        if id is not None and item_id is not None:
            raise ValueError("Cannot specify both 'id' and 'item_id' parameters. Use one or the other.")
