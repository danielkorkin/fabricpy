...
class TestRecipeJsonEdgeCases(unittest.TestCase):
    ...
    def test_result_id_with_none_result(self):
        ...
        recipe = RecipeJson({"type": "minecraft:smelting", "result": None})
    ...
    def test_result_id_dict_with_none_values(self):
        ...
        recipe = RecipeJson(
            {"type": "minecraft:smelting", "result": {"id": None, "item": None}}
        )
        self.assertIsNone(recipe.result_id)
        self.assertIsNone(recipe.get_result_id())
    ...
    def test_result_id_dict_with_empty_strings(self):
        ...
        recipe = RecipeJson(
            {"type": "minecraft:smelting", "result": {"id": "", "item": ""}}
        )
    ...
    def test_result_id_dict_only_id(self):
        ...
        recipe = RecipeJson(
            {"type": "minecraft:smelting", "result": {"id": "test:new_format"}}
        )
    ...
    def test_result_id_dict_only_item(self):
        ...
        recipe = RecipeJson(
            {"type": "minecraft:smelting", "result": {"item": "test:old_format"}}
        )
    ...
    def test_result_id_dict_neither_id_nor_item(self):
        ...
        recipe = RecipeJson(
            {"type": "minecraft:smelting", "result": {"count": 1, "nbt": {}}}
        )
        self.assertIsNone(recipe.result_id)
        self.assertIsNone(recipe.get_result_id())
    ...
    def test_deep_nesting_handling(self):
        ...
        self.assertEqual(
            recipe.data["key"]["A"]["nbt"]["display"]["Name"], "Custom Iron"
        )
