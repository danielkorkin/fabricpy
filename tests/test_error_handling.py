...
class TestItemErrorHandling(unittest.TestCase):
    ...
    def test_item_invalid_stack_size(self):
        ...
        # Negative stack size
        item_negative = Item(
            id="test:negative", name="Negative Stack", max_stack_size=-1
        )
    ...
    def test_item_with_invalid_recipe(self):
        ...
        item2 = Item(
            id="test:string_recipe", name="String Recipe", recipe="invalid json"
        )
...
class TestFoodItemErrorHandling(unittest.TestCase):
    ...
    def test_food_item_invalid_saturation(self):
        ...
        food1 = FoodItem(
            id="test:neg_sat", name="Negative Saturation", saturation=-1000.0
        )
        self.assertEqual(food1.saturation, -1000.0)

        # Very high saturation
        food2 = FoodItem(
            id="test:high_sat", name="High Saturation", saturation=1000000.0
        )
        self.assertEqual(food2.saturation, 1000000.0)

        # NaN saturation (if somehow passed)
        food3 = FoodItem(
            id="test:nan_sat", name="NaN Saturation", saturation=float("inf")
        )
    ...
    def test_food_item_non_boolean_always_edible(self):
        ...
        # String (truthy)
        food2 = FoodItem(
            id="test:str_edible", name="String Edible", always_edible="yes"
        )
...
class TestRecipeErrorHandling(unittest.TestCase):
    ...
    def test_recipe_result_id_extraction_edge_cases(self):
        ...
        # Result is None
        recipe2 = RecipeJson({"type": "minecraft:crafting_shaped", "result": None})
        self.assertIsNone(recipe2.get_result_id())

        # Result is empty dict
        recipe3 = RecipeJson({"type": "minecraft:crafting_shaped", "result": {}})
        self.assertIsNone(recipe3.get_result_id())

        # Result has no id field
        recipe4 = RecipeJson(
            {"type": "minecraft:crafting_shaped", "result": {"count": 1}}
        )
...
class TestModConfigErrorHandling(unittest.TestCase):
    ...
    def test_modconfig_none_values(self):
        ...
        with self.assertRaises(TypeError):
            ModConfig(
                mod_id=None, name=None, version=None, description=None, authors=None
            )

    def test_modconfig_empty_values(self):
        """Test ModConfig with empty values."""
        mod = ModConfig(mod_id="", name="", version="", description="", authors=[])
...
class TestItemGroupErrorHandling(unittest.TestCase):
    ...
    def test_itemgroup_unicode_values(self):
        ...
        group = ItemGroup(id="test:unicode_测试", name="Unicode Group 测试 🎮")
...
class TestEdgeCasesAndBoundaries(unittest.TestCase):
    ...
    def test_very_long_strings(self):
        ...
        item = Item(id=long_string, name=long_string, texture_path=long_string)
    ...
    def test_memory_intensive_operations(self):
        ...
        item = Item(
            id="test:large_recipe", name="Large Recipe Item", recipe=large_recipe
        )
