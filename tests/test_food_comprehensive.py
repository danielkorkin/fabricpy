...
class TestFoodItemComprehensive(unittest.TestCase):
    ...
    def test_food_item_minimal_creation(self):
        ...
        food = FoodItem(id="testmod:minimal_food", name="Minimal Food")
    ...
    def test_food_with_vanilla_food_items(self):
        ...
        # Bread-like
        bread = FoodItem(
            id="test:bread", name="Test Bread", nutrition=5, saturation=6.0
        )
    ...
    def test_food_edge_cases(self):
        ...
        super_food = FoodItem(
            id="test:super_food", name="Super Food", nutrition=100, saturation=50.0
        )
        ...
        # Zero values
        empty_food = FoodItem(
            id="test:empty_food", name="Empty Food", nutrition=0, saturation=0.0
        )
...
class TestFoodItemUsageCases(unittest.TestCase):
    ...
    def test_create_food_collection(self):
        ...
        cooked_beef = FoodItem(
            id="test:cooked_beef", name="Cooked Beef", nutrition=8, saturation=12.8
        )
    ...
    def test_food_mod_registration_simulation(self):
        ...
        foods = [
            FoodItem(
                id="foodtest:apple_pie", name="Apple Pie", nutrition=8, saturation=4.8
            ),
            FoodItem(
                id="foodtest:chocolate", name="Chocolate", nutrition=3, saturation=1.8
            ),
            FoodItem(
                id="foodtest:energy_bar",
                name="Energy Bar",
                nutrition=6,
                saturation=7.2,
                always_edible=True,
        ...
        self.assertTrue(
            all(isinstance(item, FoodItem) for item in mod.registered_items)
        )
