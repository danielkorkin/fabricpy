...
class TestRecipeComprehensive(unittest.TestCase):
        ...
        tag_recipe = RecipeJson(
            {
                "type": "minecraft:crafting_shaped",
                "pattern": ["###", "#X#", "###"],
                "key": {"#": {"tag": "minecraft:logs"}, "X": "minecraft:stick"},
    ...
    def test_recipe_result_variations(self):
        ...
        self.assertIn(
            "nbt",
            nbt_result.data["result"]
            if isinstance(nbt_result.data["result"], dict)
            else {},
        )
    ...
    def test_recipe_id_extraction(self):
        ...
        no_result_recipe = RecipeJson(
            {"type": "minecraft:crafting_shapeless", "ingredients": ["minecraft:stick"]}
        )
...
class TestRecipeUsageCases(unittest.TestCase):
    ...
    def test_recipe_mod_integration(self):
        ...
        self.assertTrue(
            all(isinstance(item.recipe, RecipeJson) for item in mod.registered_items)
        )
