...
class TestBlockComprehensive(unittest.TestCase):
    ...
    def test_block_minimal_creation(self):
        ...
        block = Block(id="testmod:minimal_block", name="Minimal Block")
    ...
    def test_block_texture_system(self):
        ...
        self.assertEqual(
            block1.inventory_texture_path, "textures/blocks/stone.png"
        )  # fallback
    ...
    def test_block_various_stack_sizes(self):
        ...
        single_block = Block(id="test:single", name="Single Block", max_stack_size=1)
        self.assertEqual(single_block.max_stack_size, 1)

        # Small stack (like buckets)
        small_stack = Block(
            id="test:small", name="Small Stack Block", max_stack_size=16
        )
        self.assertEqual(small_stack.max_stack_size, 16)

        # Default stack
        default_stack = Block(id="test:default", name="Default Block")
    ...
    def test_block_with_complex_recipes(self):
        ...
        glass = Block(id="test:glass", name="Test Glass", recipe=glass_recipe)
    ...
    def test_block_with_item_groups(self):
        ...
        # Natural blocks
        natural_block = Block(
            id="test:natural", name="Natural Block", item_group=item_group.NATURAL
        )
        ...
        custom_block = Block(
            id="test:custom", name="Custom Block", item_group=custom_group
        )
    ...
    def test_block_special_cases(self):
        ...
        self.assertNotEqual(
            glass_like.block_texture_path, glass_like.inventory_texture_path
        )
    ...
    def test_block_namespacing(self):
        ...
        # Complex namespace
        complex_ns = Block(
            id="super_mod:building:reinforced_stone", name="Reinforced Stone"
        )
    ...
    def test_block_with_shaped_recipes(self):
        ...
        blocks = [
            Block(
                id="test:compressed_stone", name="Compressed Stone", recipe=small_recipe
            ),
...
class TestBlockUsageCases(unittest.TestCase):
    ...
    def test_create_building_block_set(self):
        ...
        self.assertTrue(
            all(block.item_group == item_group.BUILDING_BLOCKS for block in blocks)
        )
    ...
    def test_block_mod_registration_simulation(self):
        ...
        self.assertTrue(
            all(isinstance(block, Block) for block in mod.registered_blocks)
        )
    ...
    def test_block_with_complex_texturing(self):
        ...
        self.assertEqual(
            simple_block.block_texture_path, simple_block.inventory_texture_path
        )
        ...
        self.assertNotEqual(
            complex_block.block_texture_path, complex_block.inventory_texture_path
        )
        ...
        self.assertEqual(
            tech_block.inventory_texture_path, "textures/items/technical.png"
        )
