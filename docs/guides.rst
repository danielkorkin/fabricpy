...
.. toctree::
   ...
   guides/block-actions

Each guide provides step-by-step instructions, complete examples, and best practices for creating different types of mod components.
